...
class encodeb64(GridLayout):
    def __init__(self, **kwargs):
        ...
        self.original = TextInput(multiline=False,foreground_color=[1,0,0,1],background_color=[0, 255/255, 228/255, 1],hint_text="Enter your data here!")
        ...
        self.out = TextInput(text="None",foreground_color=[0,1,0,1],background_color=[0,0,0,1],readonly=True,multiline=False)
